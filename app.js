...
const ICONS = {
  ...
  printer:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M6.5 9V3.5h11V9"/><rect x="2.5" y="9" width="19" height="8" rx="2"/><path d="M6.5 14.5v6h11v-6"/><line x1="6.5" y1="12.3" x2="9" y2="12.3"/></svg>`,
  wifi:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M2.5 8.8a13.8 13.8 0 0 1 19 0"/><path d="M5.8 12.6a9.2 9.2 0 0 1 12.4 0"/><path d="M9.1 16.4a4.6 4.6 0 0 1 5.8 0"/><line x1="12" y1="20" x2="12.01" y2="20"/></svg>`,
  cable:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M9 2.5v4"/><path d="M15 2.5v4"/><path d="M6.5 6.5h11v4a5.5 5.5 0 0 1-11 0z"/><line x1="12" y1="16" x2="12" y2="18.5"/><line x1="8.5" y1="21.5" x2="15.5" y2="21.5"/></svg>`
};
